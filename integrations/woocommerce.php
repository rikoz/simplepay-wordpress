		...
		class WC_Gateway_SimplePay_Gateway extends WC_Payment_Gateway {
			...
			*/
			public function payment_scripts() {
				...
				wp_enqueue_script('payment', SP_DIR_URL . 'lib/js/payment.js', array(), SP_PAYMENT_SCRIPT_VERSION, true);

				wp_enqueue_style('woocommerce_checkout', SP_DIR_URL . 'integrations/woocommerce/assets/css/checkout-page.css');

				$order_data = isset(array_values($woocommerce->cart->cart_contents)[0]) ? array_values($woocommerce->cart->cart_contents)[0] : null;
